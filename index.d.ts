...
/**
* Interface describing `slogspace`.
*/
interface Routine {
	/**
	...
	*/
	( N: number, base: number, start: number, stop: number, endpoint: boolean, x: Float32Array, strideX: number ): Float32Array;
	...
	* // x => <Float32Array>[ 1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0 ]
	*/
	ndarray( N: number, base: number, start: number, stop: number, endpoint: boolean, x: Float32Array, strideX: number, offsetX: number ): Float32Array;
}
